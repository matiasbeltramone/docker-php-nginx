...
RUN locale-gen en_US.UTF-8 && \
    ...
    php7.0-zip php7.0-fpm php7.0-mysql php7.0-redis php7.0-mcrypt \
    php7.0-imagick php7.0-xdebug php7.0-apcu php7.0-xml \
    php7.0-sqlite3 php-mbstring git \
...
RUN sed -i 's/upload_max_filesize =.*/upload_max_filesize = 64M/g'      /etc/php/7.0/fpm/php.ini
##Updated for PHP 7.0
